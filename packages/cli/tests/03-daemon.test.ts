...
try {
  ...
  // Test 2: daemon status reports stopped when daemon not running
  {
    console.log("Test 2: daemon status reports stopped when not running");
  ...
  // Test 3: daemon status --json outputs valid JSON
  {
  ...
  // Test 5: daemon restart starts daemon and can be stopped
  {
    console.log("Test 5: daemon restart starts daemon and can be stopped");
